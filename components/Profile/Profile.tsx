...
/>
  ...
  // Fetch all countries (with currencies) on mount
  useEffect(() => {
    const fetchCountries = async () => {
      ...
      try {
        ...
        if (Array.isArray(data)) {
          ...
          setSelectedCountry(nig || formatted[0]);
            ...
            for (const curCode in ct.currencies) {
              ...
              if (!currencyMap[curCode]) {
                currencyMap[curCode] = {
                  ...
                  flag: ct.flag, // using the country flag as representative
                };
              }
            }
          });
              ...
              <div className="flex items-center  ">
                ...
                <div className="flex flex-col w-[330.5] ">
                  <div className="flex items-center    justify-between">
                    ...
                    <p className="text-[14px] font-[700] text-[#4DF2BE]">Verify</p>
                  </div>
  ...
  <div
    ...
    />
        ...
        <div className="absolute top-[148%] ml-[40%] mt-2 w-[200px] bg-[#222222] rounded-[8px] shadow-lg z-50">
          <div className="py-2 max-h-[240px] overflow-y-auto">
            {languages.map((lang) => (
              ...
              >
                {lang}
                {/* little check mark for selected */}
                {selectedLang === lang && (
      ...
      <div className="w-[681px] ">
        <p className="text-[14px] font-[500] text-[#DBDBDB]">Deleting your account is permanent and cannot be undone. All your data, including transaction history and saved preferences, will be erased. You will no longer have access to your account.</p>

        <div className="flex items-center justify-center gap-[10px] w-[154px] h-[36px] bg-[#222222] p-[8px_14px] rounded-full">  
