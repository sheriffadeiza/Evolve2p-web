...
const Wallet: React.FC<QRCodeBoxProps> = () => {
  ...
  const handleConfirmSend = useCallback(async () => {
    try {
      ...
      const senderWallet = clientUser?.wallets?.find((w: any) => w.currency?.toUpperCase() === selectedAsset.symbol.toUpperCase());
          ...
          <div className="fixed inset-0 z-[70] bg-black/70 flex justify-center px-4">
            <div className="w-full max-w-sm bg-[#0F1012] rounded-t-2xl mt-auto animate-slideUp">
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex gap-2 bg-[#1A1B1E] border-l-4 border-yellow-400 p-3 rounded-lg text-xs text-gray-300"><span>⚠</span><p>Transactions are irreversible once confirmed.</p></div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-[#0F1012] rounded-xl p-4 sm:p-6 max-w-md w-full">
              ...
              <ul className="text-xs sm:text-[14px] text-[#DBDBDB] mb-3 sm:mb-4 space-y-2">
                <li className="flex items-center gap-2">✅ Generate wallet address</li>
                <li className="flex items-center gap-2">✅ Access Buy/Sell offers</li>
                <li className="flex items-center gap-2">✅ Send and receive crypto safely</li>
              </ul>
