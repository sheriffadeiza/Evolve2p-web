...
const Lauthbd: React.FC = () => {
  ...
  return (
    <div className="w-full lg:mx-0 ">
      <div className="text-white  mt-[30px] mx-auto p-8 max-w-sm flex justify-center flex-col items-center  ">
        <h2 className="text-[24px] text-[#FCFCFC] font-[700]">
          Enter Authentication code
        </h2>
        <p className="text-[16px] font-[400] mt-[-4px] mb-6 text-[#8F8F8F]">
          Please enter the 6-digit authentication code <br /> to complete your
          login.
        </p>

        {error && (
          <p className="text-[#F5918A] mb-4  ml-[-28%]">
            {error}
        ...
        <div className="flex gap-[5px]  w-full">
          {pin.map((digit, idx) => (
            <input
              ...
              className="w-full lg:w-[60px] h-[56px] rounded-[10px] border-none bg-[#222222] text-center text-xl text-[#8F8F8F] focus:outline-none focus:ring-1 focus:ring-[#1ECB84]"
              type="password"
              disabled={loading}
              autoFocus={idx === 0}
            />
