        ...
        <form className="space-y-4 w-full" onSubmit={handleLogin}>
          ...
          <div>
            <input
              ...
              className="p-3 rounded mt-[10px] lg:w-[100%] w-full mb-[10px] bg-[#222222] pt-2 pr-2 pb-2 pl-[10px] h-[56px] text-[#FCFCFC] border-none focus:outline-none"
              required
            />
          </div>
          ...
          <div className="relative">
            <input
              ...
              className="p-3 rounded mt-[10px] w-full lg:w-[100%] mb-[20px] bg-[#222222] pt-2 pr-2 pb-2 pl-[10px] h-[56px] text-[#DBDBDB] border-none focus:outline-none"
              required
            />
            <button
              type="button"
          ...
          <div
            ...
            className="lg:ml-[43%] mt-[-18px] text-end text-[14px] font-[700] text-[#FCFCFC] hover:underline cursor-pointer"
          >
            Forgot password
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="p-3 w-full lg:w-[100%] mt-[8%] bg-[#4DF2BE] text-[#0F1012] h-[56px] rounded-[100px] border border-brand-green disabled:opacity-50"
          >
            {loading ? "Logging in..." : "Log in"}
          </button>
        </form>

        <div className="flex flex-col items-center  gap-4 border-0 border-blue-500 ">
