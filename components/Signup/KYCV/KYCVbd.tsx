...
const KYCVbd = () => {
  ...
  const handleVerifyClick = async () => {
    ...
    try {
      ...
      // If backend returns inquiry_id, build the Persona link
      if (data.inquiry_id) {
      ...
      // If backend returns link, use it (fallback)
      if (data.link) {
        ...
        <div className="max-w-md w-full ml-[80px] space-y-6">
          ...
          <div className="space-y-3 mt-[60px]">
            <div className="relative">
                <button
                className="w-[430px] h-[48px] py-3 bg-[#4DF2BE] hover:bg-[#0EA371] text-white text-[14px] font-[700] border-none rounded-[100px] transition-colors flex items-center justify-center"
